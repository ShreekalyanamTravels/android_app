...
const styles = StyleSheet.create({
  ...
  footer: { backgroundColor: '#7a3010', paddingHorizontal: spacing.lg, paddingTop: spacing.md, paddingBottom: spacing.xl, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
