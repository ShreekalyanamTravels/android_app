...
import { searchFlights, buildFlightSearchQuery } from '../src/services/flightsService'
...
function arrivalDayOffset(dep, durMin) {
...
function normalizeFlight(raw, fareOption) {
